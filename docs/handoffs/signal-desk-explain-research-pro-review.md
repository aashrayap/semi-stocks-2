...
This is not asking for code review findings. It is asking for a teaching/explanation output that helps a human understand the entire app and operating loop.
...
1. **Graph readability**
   - Reduce clutter from 418 contextual edges.
