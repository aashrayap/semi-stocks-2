...
- `canonical/site-data/` stays under `canonical/` as generated reader input owned by the repo-side engine build
- `canonical/site-reader/` stays under `canonical/` as the local reader for generated site data
